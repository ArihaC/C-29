...
function setup() {
  ...
  /*bridge = new Base(15, { x: width / 2 - 400, y: height / 2 }); WRONG CODE
  ...
  /*bridge = new Bridge(15, { x: width / 2 - 400, y: height / 2 }); WRONG CODE
  jointPoint = new Bridge(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);*/

  
  Matter.Composite.add(bridge.body, jointPoint);

  //Matter.Composite.add(jointPoint); WRONG CODE
  
  //Matter.Composite.add(jointPoint, bridge.body);
  
  //Matter.Composite.add(bridge.body); WRONG CODE
